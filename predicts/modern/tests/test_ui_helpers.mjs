...
const safeOptimal={airspace_intrusion_m:0,landing_in_high_risk_airspace:false};
const conflictOptimal={airspace_intrusion_m:800,landing_in_high_risk_airspace:true};
...
assert.equal(evaluateReadiness(clearWeather,{airspace_intrusion_m:null,landing_in_high_risk_airspace:false},10).factors.airspace.status,'no-go');
