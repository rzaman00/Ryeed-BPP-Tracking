# BPP Predicts v2.8.0 — Standalone Predicts + Inflation Calculator
...
The MATLAB model reports burst height **above launch site**, and v2.8 intentionally preserves that model/output rather than silently changing the equations.
...
Verify: `http://127.0.0.1:8000/api/health` should report `2.8.0`.
