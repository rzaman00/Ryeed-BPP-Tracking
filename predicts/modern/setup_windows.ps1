...
Write-Host "[BPP Predicts v3.8.0] Checking local Python environment..." -ForegroundColor Cyan
...
if (-not (Test-Path '.env')) { Copy-Item '.env.example' '.env'; Write-Host 'Created .env with local Predicts defaults.' }
